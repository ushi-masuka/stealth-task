...
# ==========================================
# 1. STATE MANAGER & LOGGER (The "Brain")
# ==========================================
class StateManager:
    """
    ...
    def log_to_file(self, raw_message):
        """Writes clean text to the persistent log file."""
        try:
    ...
    def add_log(self, message):
        ...
        """
        # A. File Logging (Clean Text)
        self.log_to_file(message)
        
        # B. UI Logging (Color Coded)
...
class Dashboard(threading.Thread):
    ...
    def run(self):
        while not state.shutdown_flag.is_set():
            ...
            # Pad empty lines to keep UI stable
            required_lines = 3
...
def main():
    ...
    if USE_MOCK_API:
        ...
        # client.totp_login(...) # Ensure login is complete
    ...
    while True:
        try:
            ...
            scrip = scrip_list[0]
            # Reset ticker immediately to avoid showing old price
            state.update_ticker(scrip['pTrdSymbol'], 0.0) 
